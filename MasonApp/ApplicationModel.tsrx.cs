...
namespace MasonApp
{
	...
	public class ApplicationModel : AppModelBase
	{
		...
		public ApplicationModel(ITestObject contextTestObject)
		{
			...
			GitHubPage = new GitHubPageNode(contextTestObject, this);
			RebuildDescriptions();
		...
		public GitHubPageNode GitHubPage { get; private set; }
	
		#endregion
	
		#region Inner Classes
	
		public sealed class GitHubPageNode : PageNodeBase
		{
			#region Constructors
			...
			public SearchThisRepositoryEditFieldNode SearchThisRepositoryEditField { get; private set; }
		
			#endregion
		
			#region Inner Classes
		
			public sealed class SearchThisRepositoryEditFieldNode : EditFieldNodeBase
			{
				#region Constructors
